...
<%@page import="community.Community_Add"%>
...
<body>
 		...
 		if (idParam != null && !idParam.isEmpty()) {
 		    workshopId = Integer.parseInt(idParam);
 		}
...
<hr>
<br>
<p><tab1><b><u><font size="+2" color="886C65">WORKSHOP REPORT</b></u></font></tab1></p>
...
String strQuery = "SELECT COUNT(*) FROM community_table";
ResultSet rs = st.executeQuery(strQuery);
String Countrow="";
while(rs.next()){
Countrow = rs.getString(1);
out.println("WorkShop  :" +Countrow);
}
}
catch (Exception e){
e.printStackTrace();
									  ...
									  <tr>
										...
										<%  
											try{
												...
												String sql ="SELECT * from community_table WHERE id = " + workshopId;
